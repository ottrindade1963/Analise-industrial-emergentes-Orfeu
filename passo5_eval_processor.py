...
class ModelEvaluator:
    ...
    def load_data_and_model(self, model_name, dataset_name, strategy_name):
        ...
        # Primeiro, identificar linhas onde y não é NaN
        valid_y_mask = ~y_test.isna()
        X_test = X_test[valid_y_mask]
        y_test = y_test[valid_y_mask]
        
        # Depois, preencher NaNs em X com 0 (ou média) para evitar erro "Input contains NaN"
        # O XGBoost e RandomForest do scikit-learn não aceitam NaNs por padrão
