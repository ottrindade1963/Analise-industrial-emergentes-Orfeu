...
class ModelTrainer:
    ...
    def prepare_data(self):
        ...
        print(f"  DEBUG: Colunas object/string: {obj_cols}")
        print(f"  DEBUG: Colunas a remover: {cols_to_drop}")
        print(f"  DEBUG: Features usadas: {features}")
        print(f"  DEBUG: Tipos das features: {self.df[features].dtypes.to_dict()}")
        print(f"  DEBUG: Primeiras linhas de X_train:\n{self.df.loc[train_mask, features].head()}")
