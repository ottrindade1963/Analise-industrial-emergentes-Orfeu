...
class StrategyAnalyzer:
    ...
    def calculate_gains_vs_non_aggregated(self):
        ...
        baseline_df = baseline_df[['Modelo', 'RMSE_NaoAgregado', 'MAE_NaoAgregado', 'R2_NaoAgregado']]
        ...
        # Calcular ganho percentual (negativo é melhor para RMSE/MAE, positivo é melhor para R2)
    ...
    def calculate_gains_between_strategies(self):
        ...
        baseline_df = baseline_df.rename(columns={'RMSE': 'RMSE_A1', 'R2': 'R2_A1'})
        baseline_df = baseline_df[['Modelo', 'Dataset', 'RMSE_A1', 'R2_A1']]
