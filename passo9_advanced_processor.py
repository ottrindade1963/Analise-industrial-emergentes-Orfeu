...
class AdvancedAnalyzer:
    ...
    def load_data_and_model(self, model_name, dataset_name, strategy_name):
        ...
        # Preencher NaNs com 0 para evitar erros
        ...
        for dataset in config.DATASETS:
            for strategy in config.STRATEGIES:
                ...
                for model_name in config.MODELS:
                    # Ignorar SARIMAX, LSTM e TFT para análises avançadas (focar em modelos baseados em árvores)
                    ...
                    if model is not None and X_test is not None:
                        # Adicionar sufixo ao nome do modelo para identificar o cenário nos resultados
